...
class NATTopo(Topo):
    def build(self):
        ...
        h1 = self.addHost('h1', ip='200.0.0.1/24', mac='00:00:00:00:00:01', defaultRoute='via 200.0.0.254')

        h2 = self.addHost('h2', ip='192.168.1.2/24', mac='00:00:00:00:00:02', defaultRoute='via 192.168.1.254')
